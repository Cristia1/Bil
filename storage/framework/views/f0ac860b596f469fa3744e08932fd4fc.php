                            ...
                            <form method="POST" action="<?php echo e(route('register')); ?>">
                                ...
                                <div class="row mb-3">
                                    <label for="contact_name"
                                        class="col-md-4 col-form-label text-md-end"><?php echo e(__('Contact Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                            name="contact_name" value="<?php echo e(old('contact_name')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    <label for="address"
                                        class="col-md-4 col-form-label text-md-end"><?php echo e(__('Address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    <label for="business_name"
                                        class="col-md-4 col-form-label text-md-end"><?php echo e(__('Business Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    <label for="vat_number"
                                        class="col-md-4 col-form-label text-md-end"><?php echo e(__('Vat Number')); ?></label>

                                    <div class="col-md-6">
                                        <input id="vat_number" type="number"
                                            class="form-control <?php $__errorArgs = ['vat_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="vat_number"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Inv-wps/resources/views/auth/register.blade.php ENDPATH**/ ?>